...
export enum ApiSuccessCode {
  ...
  CART_UPDATE_ITEM_SUCCESS = "CART_UPDATE_ITEM_SUCCESS",
...
export enum ApiErrorCode {
  ...
  CART_ADD_ITEM_FAILED = "CART_ADD_ITEM_FAILED",
  CART_UPDATE_ITEM_FAILED = "CART_UPDATE_ITEM_FAILED",
  CART_REMOVE_ITEM_FAILED = "CART_REMOVE_ITEM_FAILED",
  CART_ITEM_ALREADY_EXISTS = "CART_ITEM_ALREADY_EXISTS",
  CART_ITEM_NOT_FOUND = "CART_ITEM_NOT_FOUND",
  CART_ALL_ITEMS_UNAVAILABLE = "CART_ALL_ITEMS_UNAVAILABLE",
